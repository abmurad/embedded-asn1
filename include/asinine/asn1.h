...
typedef enum asn1_errno {
	ERR_MALFORMED_EOF = 300,
	ERR_MALFORMED_TOKEN_TAG_TRUNCATED,
	ERR_MALFORMED_TOKEN_TRUNCATED_HEADER,
	ERR_MALFORMED_TOKEN_TRUNCATED_CONTENT,
	ERR_MALFORMED_TOKEN_LENGTH_RESERVED,
	ERR_MALFORMED_TOKEN_LENGTH_INDEFINITE,
	ERR_MALFORMED_TOKEN_LENGTH_TRUNCATED,
	ERR_MALFORMED_TOKEN_LENGTH_LEADING_ZERO,
	ERR_MALFORMED_TOKEN_LENGTH_BELOW_LONG_FORM_MIN,
	ERR_MALFORMED_POP_PARENT_NOT_FULLY_PARSED,
	ERR_MALFORMED_NULL_LENGTH_IS_NOT_ZERO,
	ERR_MALFORMED_BOOL_WRONG_LENGTH,
	ERR_MALFORMED_BOOL_INVALID_VALUE,
	ERR_MALFORMED_TIME_INVALID_SECOND,
	ERR_MALFORMED_TIME_INVALID_HOUR,
	ERR_MALFORMED_TIME_INVALID_DAY,
	ERR_MALFORMED_TIME_INVALID_MONTH,
	ERR_MALFORMED_TIME_UNKNOWN_TAG,
	ERR_MALFORMED_TIME_INVALID_YEAR,
	ERR_MALFORMED_TIME_NOT_IN_UTC,
	ERR_MALFORMED_TIME_INVALID_PAIR,
	ERR_MALFORMED_TIME_WRONG_LENGTH,
	ERR_MALFORMED_INT_NOT_SMALLEST_ENCODING,
	ERR_MALFORMED_BITSTRING_UNUSED_BITS_ARE_SET,
	ERR_MALFORMED_BITSTRING_INVALID_PADDING,
	ERR_MALFORMED_BITSTRING_INVALID_ZERO_VALUE,
	ERR_MALFORMED_BITSTRING_TOO_MANY_UNUSED_BITS,
	ERR_MALFORMED_BITSTRING_ZERO_LENGTH,
	ERR_MALFORMED_UTF8STRING_INVALID_CONTINUATION,
	ERR_MALFORMED_UTF8STRING_INVALID_LEADING_CHAR,
	ERR_MALFORMED_STRING_INVALID_CHAR,
	ERR_MALFORMED_STRING_NOT_OF_CLASS_UNIVERSAL,
	ERR_MALFORMED_OID_LEADING_BYTE_IS_ZERO,
	ERR_MALFORMED_OID_NO_END_MARKER,
	ERR_MALFORMED_OID_ZERO_LENGTH,

	ERR_MEMORY_TOKEN_TAG_TOO_LARGE,
	ERR_MEMORY_INT_TOO_LARGE,
	ERR_MEMORY_BITSTRING_BUFFER_TOO_SMALL,
	ERR_MEMORY_STRING_BUFFER_TOO_SMALL,
	ERR_MEMORY_OID_TOO_MANY_ARCS,
	ERR_MEMORY_OID_ARC_TOO_LONG,

	ERR_UNSUPPORTED_TOKEN_LENGTH_TOO_LONG,
	ERR_UNSUPPORTED_PUSH_NESTED_TOO_DEEP,

	ERR_INVALID_ABORT_ALREADY_AT_ROOT,
	ERR_INVALID_PUSH_NOT_CONSTRUCTED,
	ERR_INVALID_POP_ALREADY_AT_ROOT,
	ERR_INVALID_PUSH_TAKEN_NOT_A_SEQUENCE,
	ERR_INVALID_UINT_SIGNED_INTEGER,
	ERR_INVALID_INT_ZERO_LENGTH,
	ERR_INVALID_STRING_UNKNOWN_TAG,
	ERR_INVALID_STRING_BUFFER_TOO_SMALL,
	ERR_INVALID_STRING_CONTAINS_NULL,
	ERR_INVALID_BITSTRING_BUFFER_TOO_SMALL,
} asn1_errno_t;

#ifdef EMBEDDED_ASN1_VERBOSE
typedef struct asinine_err {
	asinine_errno_t errno;
	const char *reason;
} asinine_err_t;
#else
typedef int32_t asinine_err_t;
#endif
